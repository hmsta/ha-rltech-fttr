class RltechFttrApTableCard extends HTMLElement {
  ...
  _defaultColumns() {
    return ["alias", "mac", "ip", "online", "model", "version", "profile", "assoc_count", "channel_24", "channel_5", "uplink_label", "sn", "details"];
  }
    ...
    this.shadowRoot.innerHTML = `
      ...
      <style>
        ...
        .toolbar {
          ...
          display: grid;
          gap: 8px;
          grid-template-columns: minmax(220px, 1fr) repeat(4, minmax(96px, 150px)) auto auto auto;
          margin-bottom: 8px;
          position: relative;
        }
        input, select, button {
